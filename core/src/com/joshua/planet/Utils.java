...
//
    ...
    public static float tricosineInterpolation(float x, float y, float z) {
        ...
        float c00 = cosineInterpolation(random4(coord0[0], coord0[1], coord0[2]), random4(coord1[0], coord0[1], coord0[2]),
                xd);
        float c10 = cosineInterpolation(random4(coord0[0], coord1[1], coord0[2]), random4(coord1[0], coord1[1], coord0[2]),
                xd);
        float c01 = cosineInterpolation(random4(coord0[0], coord0[1], coord1[2]), random4(coord1[0], coord0[1], coord1[2]),
                xd);
        float c11 = cosineInterpolation(random4(coord0[0], coord1[1], coord1[2]), random4(coord1[0], coord1[1], coord1[2]),
                xd);
